...
d_dist = 0                         # distance between centers of conductors for axial displacement
...
y[2*N_t:] = list(np.asarray(y[2*N_t:]) + (d_dist - D_wire)) # adding disk separation 
...
filename = "netlist_12awg_10disk_AXDISP_5Diameter_AccInductance_2disks.txt"  # name of the txt file
N_d = 10                         # number of disks
